    ...
    <>
      <div className="page-banner-area">
        ...
        <div className="page-banner-shape-1">
          <img
            src="/images/page-banner/shape-1.png"
            alt="image"
            loading="lazy"
          />
        </div>
        <div className="page-banner-shape-2">
          <img
            src="/images/page-banner/shape-2.png"
            alt="image"
            loading="lazy"
          />
        </div>
        <div className="page-banner-shape-3">
          <img
            src="/images/page-banner/shape-3.png"
            alt="image"
            loading="lazy"
          />
        </div>
        <div className="page-banner-shape-4">
          <img
            src="/images/page-banner/shape-4.png"
            alt="image"
            loading="lazy"
          />
        </div>
