...
const TechSupport = () => {
  return (
    <>
      <div className="support-area">
        <div className="container">
          <div className="support-content">
            ...
            <p>
              In our role as a mid-sized web and app development company, we
              combine the best of both worlds. With the focus and speed of a
              small IT outsourcing company, we have the scalability and
              expertise of a large company.
            </p>
            <span>- CEO at Writ Labs </span>
          </div>
        </div>

        {/* Shape Images */}
        <div className="support-shape-1">
          <img src="/images/support/shape-1.png" alt="image" loading="lazy" />
        </div>
        <div className="support-shape-2">
          <img src="/images/support/shape-2.png" alt="image" loading="lazy" />
        </div>
        <div className="support-shape-3">
          <img src="/images/support/shape-3.png" alt="image" loading="lazy" />
        </div>
        <div className="support-shape-4">
          <img src="/images/support/shape-4.png" alt="image" loading="lazy" />
        </div>
        <div className="support-shape-5">
          <img src="/images/support/shape-5.png" alt="image" loading="lazy" />
        </div>
        <div className="support-shape-6">
          <img src="/images/support/shape-6.png" alt="image" loading="lazy" />
        </div>
      </div>
      ...
      <style jsx>{`
        .support-area {
          background-image: url(/images/support/support-bg-1.webp);
