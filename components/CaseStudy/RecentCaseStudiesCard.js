    ...
    <>
      <div className="projects-area pt-100 pb-70">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-projects-box">
                ...
                <div className="projects-content">
                  <h3>
                    <Link href="/case-study-details">
                      <a>Financial Consulting for Writ Labs</a>
                    </Link>
                  </h3>
                  <p>
                    Best Strategic planning dolor sit amet consectetur
        ...
        <div className="projects-shape-1">
          <img src="/images/projects/shape-1.png" alt="image" loading="lazy" />
        </div>
        <div className="projects-shape-2">
          <img src="/images/projects/shape-2.png" alt="image" loading="lazy" />
        </div>
        <div className="projects-shape-3">
          <img src="/images/projects/shape-3.png" alt="image" loading="lazy" />
        </div>
        <div className="projects-shape-4">
          <img src="/images/projects/shape-4.png" alt="image" loading="lazy" />
        </div>
        <div className="projects-shape-5">
          <img src="/images/projects/shape-5.png" alt="image" loading="lazy" />
        </div>
      </div>
