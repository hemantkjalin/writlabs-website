    ...
    <>
      <div className="main-banner-area">
              ...
              <div className="main-banner-content">
                {/* <ScrollAnimation animateIn="fadeInLeft" delay={50} animateOnce={true}>
                                    <div className="tag">
                                        ...
                                        # Writ Labs Best Startup Company
                                    </div>
                                </ScrollAnimation> */}
                ...
                <ScrollAnimation
                  ...
                  animateOnce={true}
                >
                  <h1>Driving HiTech Business Transformations</h1>
                </ScrollAnimation>
                ...
                >
                  <p>
                    ...
                    captivating and eye-capturing business software solutions
                    for growth.{" "}
                  </p>
                </ScrollAnimation>
        ...
        <div className="main-banner-shape-1">
          <img
            src="/images/main-banner/banner-one/shape-1.png"
            alt="image"
            loading={null}
          />
        </div>
        <div className="main-banner-shape-2">
          <img
            src="/images/main-banner/banner-one/shape-2.png"
            alt="image"
            loading={null}
          />
        </div>
        <div className="main-banner-shape-3">
          <img
            src="/images/main-banner/banner-one/shape-3.png"
            alt="image"
            loading={null}
          />
        </div>
        <div className="main-banner-shape-4">
          <img
            src="/images/main-banner/banner-one/shape-4.png"
            alt="image"
            loading={null}
          />
        </div>
