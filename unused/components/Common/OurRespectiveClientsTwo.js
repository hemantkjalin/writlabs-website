    ...
    <>
      <div className="clients-area ptb-100">
            ...
            >
              <div className="clients-item">
                ...
                <div className="shape-1">
                  <img
                    src="/images/clients/shape-4.png"
                    alt="image"
                    loading="lazy"
                  />
                </div>
                ...
                <div className="shape-2">
                  <img
                    src="/images/clients/shape-5.png"
                    alt="image"
                    loading="lazy"
                  />
                </div>
                ...
                <div className="shape-3">
                  <img
                    src="/images/clients/shape-6.png"
                    alt="image"
                    loading="lazy"
                  />
                </div>
              ...
              <div className="clients-item">
                <img
                  src="/images/clients/clients-2.png"
                  alt="image"
                  loading="lazy"
                />
                <p>
                  ‘’Writ Labs is the best digital agency in our area As a
                  midsize software developent company we combine the best of
                  both worlds. We have the focus and speed of the small it
        ...
        <div className="clients-shape-1">
          <img src="/images/clients/shape-1.png" alt="image" loading="lazy" />
        </div>
        <div className="clients-shape-2">
          <img src="/images/clients/shape-2.png" alt="image" loading="lazy" />
        </div>
        <div className="clients-shape-3">
          <img src="/images/clients/shape-3.png" alt="image" loading="lazy" />
        </div>
      </div>
