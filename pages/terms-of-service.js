  ...
  return (
    <>
      <Head>
        {/* <!-- COMMON TAGS --> */}
        <meta charSet="utf-8" />
        <title>Terms of Service | Writ Labs | Mohali</title>
        {/* <!-- Search Engine --> */}
        <meta
          name="description"
          content="Writ Labs has terms and conditions that we follow to provide you with industry-standard service."
        />
        <meta name="image" content="https://writlabs.com/images/logo.png" />
        {/* <!-- Schema.org for Google --> */}
        <meta itemProp="name" content="Terms of Service | Writ Labs | Mohali" />
        <meta
        ...
        <meta
          name="twitter:title"
          content="Terms of Service | Writ Labs | Mohali"
        />
        <meta
        ...
        <meta name="og:title" content="Terms of Service | Writ Labs | Mohali" />
        <meta
          name="og:description"
          content="Writ Labs has terms and conditions that we follow to provide you with industry-standard service."
        />
        <meta name="og:image" content="https://writlabs.com/images/logo.png" />
        <meta name="og:url" content="https://writlabs.com/terms-of-service/" />
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8 col-md-12">
              <div className="terms-of-service-content">
                ...
                <p>Our website address is: http://writlabs.com</p>
                <blockquote className="blockquote">
                  <p>
                    ...
                    with Writ Labs. We also collect some data automatically,
