  ...
  return (
    <>
      <Head>
        {/* <!-- COMMON TAGS --> */}
        <meta charSet="utf-8" />
        <title>Privacy Policy | Writ Labs | Mohali</title>
        {/* <!-- Search Engine --> */}
        <meta
          name="description"
          content="Writ Labs has a privacy policy that we follow to provide you with industry-standard service."
        />
        <meta name="image" content="https://writlabs.com/images/logo.png" />
        {/* <!-- Schema.org for Google --> */}
        <meta itemProp="name" content="Privacy Policy | Writ Labs | Mohali" />
        <meta
        ...
        <meta
          name="twitter:title"
          content="Privacy Policy | Writ Labs | Mohali"
        />
        <meta
        ...
        <meta name="og:title" content="Privacy Policy | Writ Labs | Mohali" />
        <meta
          name="og:description"
          content="Writ Labs has a privacy policy that we follow to provide you with industry-standard service."
        />
        <meta name="og:image" content="https://writlabs.com/images/logo.png" />
        <meta name="og:url" content="https://writlabs.com/privacy-policy/" />
